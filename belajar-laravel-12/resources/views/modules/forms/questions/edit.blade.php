...
@section('content')
    <div class="container mx-auto py-6">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold">Edit Question: {{ $question->question_text }}</h1>
        </div>

        <div class="bg-white shadow-md rounded p-6">
            <form action="{{ route('forms.questions.update', [$form, $question]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div id="options-container" class="mb-4 {{ in_array($question->question_type, ['radio', 'checkbox', 'select']) ? '' : 'hidden' }}">
