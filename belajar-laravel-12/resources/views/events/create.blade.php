                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('events.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('location_details') is-invalid @enderror" id="location_details" name="location_details" rows="2">{{ old('location_details') }}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price', '0.00') }}" step="0.01" min="0" required>
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Recommended size: 1200x600 pixels. Max: 2MB</small>
                            @error('banner_image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
